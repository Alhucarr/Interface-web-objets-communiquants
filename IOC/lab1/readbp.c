...
blink(void* arg)
{
    ...
    while(1){
        if(led == 0) {
            gpio_write ( GPIO_LED0, val0 );
            delay ( period );
            val0 = 1 - val0;
        } else {
            gpio_write ( GPIO_LED1, val1 );
            delay ( period );
            val1 = 1 - val1;
        }
    }
...
main ( int argc, char **argv )
{
    ...
    int period1, period2, half_period, ret0, ret1;
    int arg0[2];
    int arg1[2];
    period1 = 1000; /* default = 1Hz */
    period2 = 1500;
    if ( argc == 3 ) {
        period1 = atoi ( argv[1] );
        period2 = atoi ( argv[2] );
    ...
    // ---------------------------------------------
    //printf("arg = %d\n", arg0[0]);
    ret0 = pthread_create (&th_led_0, NULL, blink, (void*)arg0);
    ret1 = pthread_create (&th_led_1, NULL, blink, (void*)arg1);
